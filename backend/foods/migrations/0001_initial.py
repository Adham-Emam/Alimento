...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('food_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='nutrition', serialize=False, to='foods.fooditem')),
        ...
        migrations.AddField(
            model_name='meal',
            name='ingredients',
            field=models.ManyToManyField(blank=True, through='foods.MealIngredient', to='foods.fooditem'),
        ),
        migrations.CreateModel(
            name='Recipe',
            fields=[
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(related_name='recipes', through='foods.RecipeIngredient', to='foods.fooditem'),
        ),
        migrations.CreateModel(
            name='ServingSize',
            fields=[
                ...
                ('unit', models.CharField(max_length=50)),
                ('food', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='serving_size', to='foods.fooditem')),
            ],
        ),
    ]
